...
using Com.Ericmas001.DataItems;
using Com.Ericmas001.DataItems.Filters.Enums;
using Com.Ericmas001.Windows.Wpf.Entities.Filters;
using Com.Ericmas001.Windows.Wpf.ViewModels.Sections;
using Com.Ericmas001.Windows.Wpf.ViewModels.Trees;

namespace Com.Ericmas001.Windows.Wpf.ViewModels.Tabs
{
        ...
        where TDataItem : IDataItem
    {
        ...
        void m_LoadingTreeVm_OnErrorObtained(object sender, EventArgs<Exception> e)
        {
